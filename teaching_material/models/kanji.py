...
class Kanji(models.Model):
    ...
    kanji = models.TextField()  # Field name made lowercase.
    ...
    #
    # meaning = models.ForeignKey(Meaning, on_delete=models.CASCADE, null=True)

    # meaning_string = models.CharField(max_length=2555, blank=True, null=True)
    #
